...
use App\Http\Controllers\Account\Fees\FeePaymentController;

Route::group(['middleware' => ['auth', 'role:student']], function () {
    // Show fee pending page & form
    Route::get('user-student/fee-pending', [FeePaymentController::class, 'showPendingForm'])
        ->name('fee.pending');

    // Handle fee submission (student)
    Route::post('user-student/fee-submit', [FeePaymentController::class, 'store'])
        ->name('user-student.fee.submit');
});
...
Route::group(['prefix' => 'user-student/', 'as' => 'user-student', 'middleware' => ['role:student', 'feepaid'], 'namespace' => 'UserStudent\\'], function () {
...
Route::group(['prefix' => 'student/', 'as' => 'student', 'namespace' => 'Student\\'], function () {
    ...
    Route::get('scrutiny', ['as' => '.scrutiny', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@scrutiny']);
    Route::get('confirmadmission', ['as' => '.confirmadmission', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@confirmadmission']);
    Route::post('admissionconfirmed', ['as' => '.admissionconfirmed', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@admissionconfirmed']);
    Route::post('markforinterview', ['as' => '.markforinterview', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@markforinterview']);
    Route::post('saveinterviewmarks', ['as' => '.saveinterviewmarks', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@saveinterviewmarks']);
    Route::post('notifystudent', ['as' => '.notifystudent', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@notifystudent']);
    Route::post('dropstudents', ['as' => '.dropstudents', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@dropstudents']);
    Route::get('meritlist', ['as' => '.meritlist', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@meritlist']);
    Route::get('interview', ['as' => '.interview', 'middleware' => ['ability:super-admin,student-scrutiny'], 'uses' => 'StudentController@interview']);
    ...
    Route::post('getstudentbystatus', ['as' => '.getstudentbystatus', 'uses' => 'StudentController@findStudentsByStatus']);
...
Route::group([
    'prefix' => 'admin/fees',
    'as' => 'admin.fees.',
    'middleware' => ['auth', 'role:super-admin,account,student-affairs'],
], function () {
    Route::get('payments', [FeePaymentController::class, 'index'])->name('payments.index');
    Route::post('payments/{id}/approve', [FeePaymentController::class, 'approve'])->name('payments.approve');
    Route::post('payments/{id}/reject', [FeePaymentController::class, 'reject'])->name('payments.reject');
});
...
Route::group(['prefix' => 'account/', 'as' => 'account.', 'namespace' => 'Account\\'], function () {
    ...
    Route::get('fees/showpendingform', ['as' => 'fee.pending', 'middleware' => ['ability:super-admin,fees-index'], 'uses' => 'Fees\FeePaymentController@showPendingForm']);
    /*Balance Fees*/
    ...
    Route::get('fees/fines', ['as' => 'fees.fines', 'middleware' => ['ability:super-admin,fees-fines'], 'uses' => 'Fees\FinesController@index']);
...
Route::group(['prefix' => '/', 'as' => '', 'namespace' => 'Academic\\'], function () {
    ...
    Route::get('dynamic/domicile', ['as' => 'dynamic.domicile', 'middleware' => ['ability:super-admin,dynamic-domicile-index'], 'uses' => 'Dynamic\DomicileController@index']);
    Route::post('dynamic/domicile/store', ['as' => 'dynamic.domicile.store', 'middleware' => ['ability:super-admin,dynamic-domicile-add'], 'uses' => 'Dynamic\DomicileController@store']);
    Route::get('dynamic/domicile/{id}/edit', ['as' => 'dynamic.domicile.edit', 'middleware' => ['ability:super-admin,dynamic-domicile-edit'], 'uses' => 'Dynamic\DomicileController@edit']);
    Route::post('dynamic/domicile/{id}/update', ['as' => 'dynamic.domicile.update', 'middleware' => ['ability:super-admin,dynamic-domicile-update'], 'uses' => 'Dynamic\DomicileController@update']);
    Route::get('dynamic/domicile/{id}/delete', ['as' => 'dynamic.domicile.delete', 'middleware' => ['ability:super-admin,dynamic-domicile-delete'], 'uses' => 'Dynamic\DomicileController@delete']);
...
//     //return QrCode::size(500)->generate('Welcome to http://alampk.com');
// });
