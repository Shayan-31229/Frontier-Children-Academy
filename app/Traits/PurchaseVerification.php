...
trait PurchaseVerification {
    ...
    public function getPurchaseDetail()
    {
        return (object)[
            'buyer' => 'Shayan Khan',
            'sold_at' => now()->subMonths(3), // Sold 3 months ago
            'supported_until' => now()->addMonths(9), // Support valid for 9 more months
        ];
        /*
        ...
        if(getenv('CERTIFICATE_DATE') !== $dateCheck){
            ...
            $userAgent = "Purchase code verification for Frontier Children Academy.";
