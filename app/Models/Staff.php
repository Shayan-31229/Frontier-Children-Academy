...
{
    protected $fillable = ['created_by', 'last_updated_by', 'reg_no', 'join_date', 'designation', 'first_name',  'last_name',
        'father_name', 'date_of_birth', 'gender', 'blood_group', 'nationality',
        'cnic_no', 'home_phone', 'mobile_1', 'mobile_2', 'email',
        'address', 'state', 'country',
        'temp_address', 'temp_state', 'temp_country',
