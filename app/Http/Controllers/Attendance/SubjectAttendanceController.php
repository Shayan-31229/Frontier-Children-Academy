...
class SubjectAttendanceController extends CollegeBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('students_id')) {
            ...
            $request->session()->flash($this->message_warning, 'You Have No Student to Managed Attendance. ');
            return back();
        }
    ...
    public function findSubject(Request $request)
    {
        ...
        if ($subjects) {
            ...
            $response['error'] = 'No Subject Found to Manage Attendance. Please Contact Your Administrator.';
        }
    ...
    public function studentHtmlRow(Request $request)
    {
        ...
        if(auth()->user()->hasRole('staff')) {
            ...
            if($activeStudent) {
                ...
                $response['error'] = 'No Active Students in This Faculty/Semester.';
            }
        }
