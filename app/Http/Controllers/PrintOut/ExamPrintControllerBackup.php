    ...
    public function examMarkSheet(Request $request)
    {
        if($request->get('result-type')=='transcript'){
            ...
            if ($request->has('chkIds')) {
                ...
                $exam_schedule_id = ExamSchedule::select('id')->where($examScheduleCondition)->first();
                
                // The above lines are added by Shayan Khan to remove the error regarding $exam_schedule_id.
