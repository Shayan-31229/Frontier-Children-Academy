...
class ExamPrintController extends CollegeBaseController
{
    ...
    public function admitCard(Request $request)
    {
        ...
        // $data['student'] = Student::select('id','reg_no','date_of_birth', 'first_name', 'middle_name', 'last_name', 'cnic_no', 'student_image','gender','blood_group')
        ...
        'students.faculty', 'students.semester', 'students.cnic_no', 'students.batch', 'students.academic_status',
        'students.first_name', 'students.middle_name', 'students.last_name', 'students.date_of_birth', 'students.gender',
        'students.student_image', 'students.blood_group', 'pd.father_first_name', 'pd.father_middle_name', 'pd.father_last_name')
        ->whereIn('students.id',  $request->get('chkIds'))
        ...
        $examScheduleCondition = [
          ...
          /*Find Exam Schedule Id*/
                ...
                if(count($examScheduleId) > 0){
                    ...
                    $request->session()->flash($this->message_warning, 'No Examination Scheduled. for Your Target Exam. Please Schedule First.');
