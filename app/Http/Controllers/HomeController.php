...
class HomeController extends CollegeBaseController
{
    ...
    public function index()
    {
        ...
        /*Accounting*/
        $data['recent_fees_collection'] = FeeCollection::select(
            'fee_collections.date',
            'fee_collections.students_id',
            'fee_collections.fee_masters_id',
        ...
        $data['recent_payroll_pay'] = SalaryPay::select(
            'salary_pays.date',
            'salary_pays.staff_id',
            'salary_pays.salary_masters_id',
            'salary_pays.paid_amount',
            's.reg_no',
            'ph.title'
        )
        ...
        $data['recent_transaction'] = Transaction::select(
            'transactions.date',
            'transactions.tr_head_id',
            'transactions.dr_amount',
            'transactions.cr_amount',
            'th.tr_head'
        )
        ...
        /*Library*/
        $data['book_issued'] = BookIssue::select(
            'book_issues.member_id',
            'book_issues.issued_on',
            'book_issues.due_date',
            'b.book_code',
            'bm.id as bookmaster_id',
            'bm.title',
            'lm.member_id as lib_id',
            'lm.user_type'
        )
        ...
        $data['book_return_over'] = BookIssue::select(
            'book_issues.member_id',
            'book_issues.issued_on',
            'book_issues.due_date',
            'b.book_code',
