...
class OnlineRegistrationSettingController extends CollegeBaseController
{
    ...
    {
        $this->folder_path = DIRECTORY_SEPARATOR.'images'.DIRECTORY_SEPARATOR.'setting'.DIRECTORY_SEPARATOR.$this->folder_name.DIRECTORY_SEPARATOR;
    }
    ...
    public function programHtml()
    {
        ...
        if ($baseOfRegistration && $baseOfRegistration->base == "faculty" && $existingProgram->count() > 0) {
    ...
    public function findSemester(Request $request)
    {
        ...
        if ($baseOfRegistration && $baseOfRegistration->base == "semester" && $existingProgram->count() > 0){
