                            ...
                            case 'Active':
                                if($hostel && $room && $bed){
                                    ...
                                    if($availableBed) {
                                        ...
                                        $request->session()->flash($this->message_success, 'No Bed Available in Your Target Hostel Room.');
                                    }
                                }elseif($hostel){
                                    /*Create Bed Available When Resident Leave*/
                                    $oldBedStatus = Bed::find($row->beds_id);
                                    ...
                                    $request->session()->flash($this->message_warning, 'No Hostel Selected. Please, Select Hostel.');
                                }
                                break;
                            case 'Shift':
                                if($hostel && $room && $bed){
