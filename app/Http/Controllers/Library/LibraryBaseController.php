...
class LibraryBaseController extends CollegeBaseController
{
    ...
    public function returnBook(Request $request, $id)
    {
        ...
        if (!$data['book'])
            return parent::invalidRequest();
        //todo::when book status available send warning not library rout not found
    ...
    {
        $data = [];
        $data['history'] = BookIssue::select('book_issues.id', 'book_issues.member_id as lmid',
            ...
            'lm.user_type','lm.member_id as reglinkid')
            ->where(function ($query) use ($request) {
