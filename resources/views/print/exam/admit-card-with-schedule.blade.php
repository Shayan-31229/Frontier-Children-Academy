                                        ...
                                        <div class="widget-box transparent">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="father_name">
                                                                <strong>{{ $student->father_first_name.' '.$student->father_middle_name.' '.$student->father_last_name }}</strong>
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span class="editable" id="student_cnic_no"><strong>{{ $student->cnic_no }}</strong></span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="well well-sm">
                                                    Note: | Students late more than 15 minutes will not be allowed to exam
                                                </div>
                                            </div>
