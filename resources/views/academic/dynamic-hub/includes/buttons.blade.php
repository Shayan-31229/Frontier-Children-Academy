<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-center">
        ...
        <a class="{!! request()->is('dynamic/domicile')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('dynamic.domicile') }}"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{__('academic.child.dynamic_gallery.child.domicile')}}</a>
    </div>
</div>
<hr class="hr-6">