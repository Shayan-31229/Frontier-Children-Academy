...
<div class="form-group">
    {!! Form::label('max_students', 'Maximum Students', ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
        {!! Form::text('max_students', null, ["class" => "form-control border-form upper", "required"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'max_students'])
    </div>
</div>
