        ...
        <div id="generalInfo" class="tab-pane active">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('last_name', null, ["placeholder" => "LAST NAME", "class" => "form-control border-form upper"]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('cnic_no', null, ["placeholder" => "", "class" => "form-control border-form upper", "maxlength" => "13"]) !!}
