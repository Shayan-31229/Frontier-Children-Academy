        ...
        <div class="auto-container clearfix">
            ...
            <div class="pull-right upper-right clearfix">
                ...
                <div class="upper-column info-box">
                    ...
                    <ul>
                        <li><strong> <a href="tel:0915612015" class="btn btn-success">Call Us</a></strong>{{ isset($contact_info->phone)?$contact_info->phone:"" }}</li>
                    </ul>
                </div>
                ...
                <div class="upper-column info-box">
                    ...
                    <ul>
                        <li><strong><a href="mailto:dos.shayan@gmail.com" class="btn btn-success">Email</a></strong>{{ isset($contact_info->email)?$contact_info->email:"" }}</li>
                    </ul>
                </div>
            </div>
        </div>
