...
<hr class="hr-16">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <select name="semesters_id" 
                @if(isset($data['row']) && $data['row']->semester)
                    data-selected="{{ $data['row']->semester }}"
                @endif
            class="form-control semesters_id" onChange="loadSubject(this)" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <select name="subjects_id"
                @if(isset($data['row']) && $data['row']->subjects_id)
                    data-selected="{{ $data['row']->subjects_id }}"
                @endif
            class="form-control semester_subject" >
