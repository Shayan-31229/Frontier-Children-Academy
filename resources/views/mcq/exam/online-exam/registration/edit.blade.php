...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function ($) {
            ...
            $('select[name="faculty"]').trigger("change");
        });
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $.each(data.semester, function(key,valueObj){
                            if($('.semesters_id').data("selected") == valueObj.id){
                                $('.semesters_id').append('<option selected value="'+valueObj.id+'">'+valueObj.semester+'</option>');
                            }
                            else
                            {
                    ...
                    success: function (response) {
                        ...
                        if (data.error) {
                            ...
                            $.each(data.subjects, function (key, valueObj) {
                                if($('.semester_subject').data("selected") == key){
                                    $('.semester_subject').append('<option selected value="' + key + '">' + valueObj + '</option>');
                                }
                                else
                                {
                            ...
                            $(".semester_subject").trigger("change");
                        }
                    }
                });
            }
