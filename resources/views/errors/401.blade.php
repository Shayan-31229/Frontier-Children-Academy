                    ...
                    <div class="error-container">
                        <div class="well">
                            ...
                            <ul class="list-unstyled spaced inline bigger-110 margin-15">
                                ...
                                <li>
                                    <i class="ace-icon fa fa-hand-o-right blue"></i>
                                    <a href="https://alampk.com" target="_blank">Buy New License</a>
                                </li>

                                <li>
                                    <i class="ace-icon fa fa-hand-o-right blue"></i>
                                    <a href="http://alampk.com/support" target="_blank">Contact Developer for support.</a>
                                    <p>
                                        Email/Skype:dos.shayan@gmail.com<br>
                                        WhatsApp:+923330700333
                                    </p>
                                </li>
                            </ul>
                        </div>
