    ...
    <head>
        ...
        <style>
            ...
            .login-container .form-control:focus {
                border-color: #4e73df;
                box-shadow: 0px 0px 8px rgba(78,115,223,0.3);
            }
            ...
            .btn-primary {
                ...
                padding: 6px;
                font-weight: 600;
                /* background: #3b60d1ff !important; */
                border: none;
                transition: background 0.3s;
            }

            .btn-primary:hover {
                background: #0d2364ff !important;
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="login-container">
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <h4 class="header blue lighter bigger fadeIn">
                        ...
                        <h5 class="blue text-center" id="id-company-text">
                            ...
                            @else
                                <a href="http://alampk.com" target="_blank">©Cyber Arts</a>
                            @endif
                        </h5>
