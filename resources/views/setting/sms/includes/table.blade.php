<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ $panel }} List <em>( If you have new SMS Company/API send API detail on dos.shayan@gmail.com for Integration.)</em></h4>
        <div class="clearfix">
                                        ...
                                        @foreach($configuarations as $key => $conf)
                                            ...
                                            <div class="col-sm-8">
                                                @if(strtolower($key) == "password")
                                                    <input type="password" value="{{$conf}}" name="{{$key}}" {{ $Gateway->status=="active"?"":"disabled" }} class="form-control border-form">
                                                @else
