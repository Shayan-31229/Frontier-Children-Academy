<div id="sidebar" class="sidebar h-sidebar navbar-collapse collapse ace-save-state hidden-print">
    ...
    <!-- <div class="sidebar-shortcuts hidden-print" id="sidebar-shortcuts">
    ...
    <ul class="nav nav-list hidden-print">
        ...
        <li class="{!! request()->is('dashboard') ? 'active' : '' !!}">
            <a href="{{ route('dashboard') }}">
                <i class="menu-icon-new fa fa-tachometer"></i>
                    ...
                    <ul class="submenu">
                        <li class="{!! request()->is('student*') ? 'active open' : '' !!} hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="{!! request()->is('student/interview') ? 'active' : '' !!} hover">
                                    <a href="{{ route('student.interview') }}">
                                        <i class="menu-icon-new fa fa-caret-right"></i>
            ...
            <ul class="submenu">
                <li class="{!! request()->is('account/fees*') ? 'active open' : '' !!} hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="{{ request()->is('admin/fees/payments') ? 'active' : '' }} hover">
                            <a href="{{ route('admin.fees.payments.index') }}">
                                <i class="menu-icon-new fa fa-caret-right"></i>
                                {{ __('account.child.fees.child.prospectus') }}
                            </a>
                            <b class="arrow"></b>
                        </li>
                    ...
                    <ul class="submenu">
                        <li class="{!! request()->is('account/report/cash-book*') ? 'active' : '' !!} hover">
                            <a href="{{ route('account.report.cash-book') }}">
                                <i class="menu-icon-new fa fa-cash"></i>
                ...
                <li class="{!! request()->is('account.transaction*') ? 'active open' : '' !!} hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li
                            class="{!! request()->is('account/transaction/account-group/chart-of-account') ? 'active' : '' !!} hover">
    ...
    @if(isset($generalSetting) && $generalSetting->library == 1)
        <li class="{!! request()->is('library*') ? 'active' : '' !!} hover">
            ...
            <ul class="submenu">
                ...
                <li
                    class="{!! request()->is('library/member*') || request()->is('library/student*') || request()->is('library/staff*') ? 'active' : '' !!} hover">
                    <a href="#" class="dropdown-toggle">
                        <i class="menu-icon-new fa fa-caret-right"></i>
    ...
    @if(isset($generalSetting) && $generalSetting->application == 1)
        <li class="{!! request()->is('application*') ? 'active' : '' !!} hover">
            <a href="{{ route('application.index') }}">
                <i class="menu-icon-new fa fa-files-o"></i>
                {{__('application.name')}}
            </a>
            <b class="arrow"></b>
        </li>
            ...
            <ul class="submenu">
                ...
                <li class="{!! request()->is('dynamic*') ? 'active' : '' !!} hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="{!! request()->is('dynamic/domicile*') ? 'active' : '' !!} hover">
                            <a href="{{ route('dynamic.domicile') }}">
                                <i class="menu-icon-new fa fa-caret-right"></i>
                                {{__('academic.child.dynamic_gallery.child.domicile')}}
                            </a>
