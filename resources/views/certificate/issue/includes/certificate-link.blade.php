...
<a href="{{ route('certificate.provisional.add', ['id' => encrypt($student->id)]) }}" target="_blank" class="btn btn-sm btn-primary white">
    <i class="ace-icon fa fa-certificate align-top bigger-125 icon-on-right"></i>
    Provisional
</a>

<a href="{{ route('certificate.testimonial.add', ['id' => encrypt($student->id)]) }}" target="_blank" class="btn btn-sm btn-primary white">
    <i class="ace-icon fa fa-certificate  align-top bigger-125 icon-on-right"></i>
    Testimonial
</a>

<a href="{{ route('certificate.moi.add', ['id' => encrypt($student->id)]) }}" target="_blank" class="btn btn-sm btn-primary white">
    <i class="ace-icon fa fa-certificate  align-top bigger-125 icon-on-right"></i>
    MOI
</a>
<a href="{{ route('certificate.transcript.add', ['id' => encrypt($student->id)]) }}" target="_blank" class="btn btn-sm btn-primary white">
    <i class="ace-icon fa fa-certificate  align-top bigger-125 icon-on-right"></i>
    Transcript
</a>
