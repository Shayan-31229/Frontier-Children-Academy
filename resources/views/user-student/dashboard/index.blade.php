        ...
        $data['student']->middle_name . ' ' . $data['student']->last_name }}</div>
                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"
                                                id="reg_date">{{ \Carbon\Carbon::parse($data['student']->reg_date)->format('Y-m-d')}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"
                                                id="university_reg">{{ $data['student']->university_reg }}</span>
                                        </div>
                                        <div class="profile-info-name"> DOB : </div>
                                        <div class="profile-info-value">
                                            <span class="editable"
                                                id="student_name">{{ \Carbon\Carbon::parse($data['student']->date_of_birth)->format('Y-m-d')}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"
                                                id="student_name">{{ $data['student']->blood_group }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"
                                                id="student_name">{{ $data['student']->nationality }}</span>
                                        </div>
                                        <div class="profile-info-name"> CNIC No: </div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="student_name">{{ $data['student']->cnic_no }}</span>
                                        </div>
                                    </div>
                            ...
                            @switch($data['student']->preadmission)
                                @case(1)
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="alert alert-warning center" style="padding: 20px; font-size: 20px; border-radius: 8px;">
                                            <i class="ace-icon fa fa-info-circle bigger-150"></i>
                                            <strong>Account Status: </strong>
                                            <span class="label label-warning label-xlg arrowed-in arrowed-right" style="margin-left:10px;">
                                ...
                                @case(2)
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="alert alert-danger center" style="padding: 20px; font-size: 20px; border-radius: 8px;">
                                            <i class="ace-icon fa fa-exclamation-triangle bigger-150"></i>
                                            <strong>Account Status: </strong>
                                            <span class="label label-danger label-xlg arrowed-in arrowed-right" style="margin-left:10px;">
                                                {{ $data['student']->description }}
                                            </span>
                                        </div>
                                    </div>
