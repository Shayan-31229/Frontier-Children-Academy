    ...
    <div class="col-xs-12 col-sm-9 col-print-9">
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                ...
                @if($data['student']->cnic_no !="")
                    <div class="profile-info-name"> CNIC No: </div>
                    <div class="profile-info-value">
                        <span class="editable" id="cnic_no">{{  ViewHelper::getStudentCNICNo( $data['student']->id ) }}</span>
                    </div>
                @endif
            </div>
            ...
            <div class="profile-info-row">
                @if($data['student']->pnc_reg_no !="")
                    <div class="profile-info-name"> PNC Reg No : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="pnc_reg_no">{{ $data['student']->pnc_reg_no }}</span>
                    </div>
                @endif
                @if($data['student']->kmu_reg_no !="")
                    <div class="profile-info-name"> KMU Reg No : </div>
                    <div class="profile-info-value">
                        <span class="editable" id="kmu_reg_no">{{ $data['student']->kmu_reg_no }}</span>
                    </div>
                @endif
            </div>
            </div>
...
<div class="row">
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->cnic_no !="")
                <div class="profile-info-name"> CNIC No. : </div>
                <div class="profile-info-value">
                    <span class="editable">{{ $data['student']->cnic_no }}</span>
                </div>
            @endif
        </div>
    </div> -->
    ...
    <div class="space-6"></div>
    <div class="label label-info label-xlg arrowed-in arrowed-right arrowed">Parental Info</div>
    ...
    <div class="profile-user-info profile-user-info-striped">
        ...
        <div class="profile-info-row">
            ...
            @endif
            @if($data['student']->father_cnic !="")
                <div class="profile-info-name"> CNIC No. :</div>
                <div class="profile-info-value">
                    <span class="editable" id="father_office_number">{{ $data['student']->father_cnic }}</span>
                </div>
            @endif
