                                            ...
                                            <div class="well">
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            {!! Form::text('cnic_no', null, ["placeholder" => "", "class" => "form-control border-form",/*'maxlength' => 15,*/]) !!}
                                                        </div>

                                                        {!! Form::label('date_of_birth', 'Date of Birth', ['class' => 'col-sm-2 control-label']) !!}
                                                        <div class="col-sm-2">
                                                            {!! Form::text('date_of_birth', null, ["class" => "form-control border-form date-picker input-mask-date","required", "autocomplete" => "off"]) !!}
                                                        </div>
                                                    </div>
                                                </div>
