<div class="tabbable">
    ...
    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
        ...
        <!-- <li id="academicInfoTab">
            <a data-toggle="tab" href="#academicInfo" onclick="activeAcademicInfo()"><i class="fa fa-certificate"></i> {{__('form_fields.student.tabs.academic_info')}}</a>
        </li>
        <li id="profileImageTab">
            <a data-toggle="tab" href="#profileImage" onclick="activeProfileImage()"><i class="fa fa-image"></i> {{__('form_fields.student.tabs.profile_image')}}</a>
        </li> -->
        <!--<li id="ruleAgreementTab">-->
        <!--    <a data-toggle="tab" href="#ruleAgreement"  onclick="activeRuleAgreement()"><i class="fa fa-certificate"></i> {{__('form_fields.student.tabs.annexure')}}</a>-->
        <!--</li>-->
