<div class="form-group">
    ...
    <div class="col-sm-2">
        {!! Form::select('academic_statuses', $data['academic_statuses'], null, ['class' => 'form-control', 'onChange' => 'loadSemesters(this);']) !!}
    </div>
    <div class="col-sm-2">
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        {!! Form::text('first_name', null, ["class" => "form-control border-form upper", 'placeholder' => 'First Name']) !!}
...
<div class="form-group">
    ...
    <div class=" col-sm-3">
        <div class="input-group ">
            {!! Form::text('date_of_birth_start_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "input-sm form-control border-form input-mask-date date-picker", "data-date-format" => "yyyy-mm-dd", 'autocomplete' => 'off']) !!}
            <span class="input-group-addon">
                <i class="fa fa-exchange"></i>
            </span>
            {!! Form::text('date_of_birth_end_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "input-sm form-control border-form input-mask-date date-picker", "data-date-format" => "yyyy-mm-dd", 'autocomplete' => 'off']) !!}
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        {!! Form::text('cnic_no', null, ["placeholder" => "CNIC No", "class" => "form-control border-form"]) !!}
    </div>
