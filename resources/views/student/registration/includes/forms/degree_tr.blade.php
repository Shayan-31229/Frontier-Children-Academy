                ...
                @if(isset($data['degrees']) && $data['degrees']->count() >0)
                    @foreach($data['degrees'] as $degree)
                        <tr class="option_value">
                            ...
                            <td>
                                {!! Form::text('receive_in_college_date[]', $degree->receive_in_college_date, ["class" => "form-control date-picker border-form input-mask-date", 'autocomplete' => 'off']) !!}
                            </td>

                            <td>
                                {!! Form::text('issue_date[]', $degree->issue_date, ["class" => "form-control date-picker border-form input-mask-date", 'autocomplete' => 'off']) !!}
                            </td>
                            <td></td>
