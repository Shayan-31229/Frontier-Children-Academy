    ...
    @if(Config::get('edufirmconfig.student.registration.tabs.general_info.grand_father') == 1)
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('grandfather_first_name', null, [ "class" => "form-control border-form upper", "placeholder" => "Grandfather first name"]) !!}
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('grandfather_last_name', null, [ "class" => "form-control border-form upper", "placeholder" => "Grandfather last name"]) !!}
    ...
    @if(Config::get('edufirmconfig.student.registration.tabs.general_info.father') == 1)
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('father_first_name', null, [ "class" => "form-control border-form upper","required", "placeholder" => "Father first name"]) !!}
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('father_last_name', null, [ "class" => "form-control border-form upper", "placeholder" => "Father last name"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_eligibility', null, ["placeholder" => "Qualification", "class" => "form-control border-form upper"]) !!}
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_occupation', null, ["placeholder" => "Father Occupation", "class" => "form-control border-form upper"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_office', null, ["placeholder" => "Office Address", "class" => "form-control border-form upper"]) !!}
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_office_number', null, ["placeholder" => "Office Contact No.", "class" => "form-control border-form upper"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_residence_number', null, ["placeholder" => "Father Residence No.", "class" => "form-control border-form input-mask-mobile"]) !!}
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_mobile_1', null, ["placeholder" => "Father primary contact.", "class" => "form-control border-form input-mask-mobile"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_mobile_2', null, ["placeholder" => "Father secondary contact.", "class" => "form-control border-form input-mask-mobile"]) !!}
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('father_email', null, ["placeholder" => "Father email address.", "class" => "form-control border-form"]) !!}
    ...
    @if(Config::get('edufirmconfig.student.registration.tabs.general_info.mother') == 1)
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('mother_first_name', null, ["placeholder" => "Mother first name.", "class" => "form-control border-form upper","required"]) !!}
            ...
            <div class="col-sm-3">
                ...
                {!! Form::text('mother_last_name', null, ["placeholder" => "Mother last name.", "class" => "form-control border-form upper"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('mother_eligibility', null, ["placeholder" => "Qualification", "class" => "form-control border-form upper"]) !!}
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('mother_occupation', null, ["placeholder" => "Occupation", "class" => "form-control border-form upper"]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                {!! Form::text('mother_office', null, ["placeholder" => "Mother Office", "class" => "form-control border-form upper"]) !!}
    ...
    @if(Config::get('edufirmconfig.student.registration.tabs.general_info.guardian') == 1)
        ...
        <div id="guardian-detail">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::text('guardian_first_name', null, [ "class" => "form-control border-form upper","required", "placeholder"=>"Guardian's First Name"]) !!}
                    @include('includes.form_fields_validation_message', ['name' => 'guardian_first_name'])
                </div>

                <div class="col-sm-3">
                    {!! Form::text('guardian_last_name', null, [ "class" => "form-control border-form upper", "placeholder" => "Guardian's last name"]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_office', null, ["placeholder" => "Office Name", "class" => "form-control border-form upper"]) !!}
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_office_number', null, ["placeholder" => "Office number", "class" => "form-control border-form upper"]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_residence_number', null, ["class" => "form-control border-form input-mask-mobile", "placeholder"=>"Residence number"]) !!}
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_mobile_1', null, ["class" => "form-control border-form input-mask-mobile", "placeholder"=>"Primary mobile number"]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_mobile_2', null, ["class" => "form-control border-form input-mask-mobile", "placeholder"=>"Secondary mobile number"]) !!}
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_email', null, ["class" => "form-control border-form", "placeholder"=>"Guardian's email address"]) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_relation', null, ["class" => "form-control border-form upper","required", "placeholder"=>"Relationship"]) !!}
                ...
                <div class="col-sm-4">
                    {!! Form::text('guardian_address', null, ["class" => "form-control border-form upper", "required", "placeholder"=>"Address"]) !!}
