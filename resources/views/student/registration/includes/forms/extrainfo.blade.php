<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            {!! Form::text('total_fee_per_year', "0", ["placeholder" => "", "class" => "form-control border-form input-mask-registration", "value" => "0"]) !!}
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            {!! Form::text('placement_date', null, ["class" => "form-control date-picker border-form input-mask-date", 'autocomplete' => 'off']) !!}
