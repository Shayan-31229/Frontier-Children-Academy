        ...
        <div class="widget-main no-padding">
            ...
            <table class="table table-bordered table-striped">
                <thead class="thin-border-bottom">
                    <tr>
                        <th colspan="2"> <i class="ace-icon fa fa-users green"></i>Faculty Active Students</th>
                    </tr>
                </thead>
                ...
                @if (isset($data['student_faculty_wise_active_status']) && $data['student_faculty_wise_active_status']->count() > 0)
                    ...
                    @foreach($data['student_faculty_wise_active_status'] as $key => $faculties)
                        <tr>
                            <th colspan="2">
                                {{$key}} - <b class="green">{{$faculties->sum('total')}}</b>
                            </th>
                            <td>
                         ...
                         <tr>
                             ...
                             <td>
                                 <b class="green">{{$faculties->sum('total')}}</b>
                             </td>
                         </tr>
                    @endforeach
                @else
